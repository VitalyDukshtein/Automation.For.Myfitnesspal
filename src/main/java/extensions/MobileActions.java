...
public class MobileActions extends CommonOps {
    ...
    @Step("Tap back on keyboard")
    public static void tapOnBackKey(){
        ((AndroidDriver<MobileElement>) mobileDriver).pressKey(new KeyEvent().withKey(AndroidKey.BACK));
    }

    @Step("Tap Enter on keyboard")
    public static void tapOnEnterKey(){
        ((AndroidDriver<MobileElement>) mobileDriver).pressKey(new KeyEvent().withKey(AndroidKey.ENTER));
    }
    ...
    @Step("Press on Element")
    public static void enter(MobileElement elem){
        wait.until(ExpectedConditions.visibilityOf(elem));
        ((AndroidDriver<MobileElement>) mobileDriver).pressKey(new KeyEvent().withKey(AndroidKey.ENTER));
    //pressKey(new KeyEvent().withKey(AndroidKey.ENTER));
    }
}
